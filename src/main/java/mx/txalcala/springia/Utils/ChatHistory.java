package mx.txalcala.springia.Utils;
...
/*
 * 👉 En resumen:
Esta clase actúa como un gestor de historial de chats.

Agrupa mensajes intermedios (p. ej., fragmentos de respuesta de un modelo de IA).

Cuando detecta el final (STOP o USER), los consolida.

Guarda el historial en memoria (thread-safe con ConcurrentHashMap).

Permite consultar todo el historial o solo los últimos N mensajes.
 */
@Component
